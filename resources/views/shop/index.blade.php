                                        ...
                                        <div class="accordion-body">
                                            <ul class="category-list custom-padding">
                                                @foreach ($brands as $brand)
                                                    <li>
                                                        <div class="form-check ps-0 m-0 category-list-box">
                                                            <input class="checkbox_animated" type="checkbox" name="brands[]"
                                                                value="{{ $brand->id }}"
                                        ...
                                        <div class="accordion-body">
                                            <ul class="category-list custom-padding">
                                                ...
                                                @foreach ($priceRanges as $range => $label)
                                                    <li>
                                                        <div class="form-check ps-0 m-0 category-list-box">
                                                            <input class="checkbox_animated" type="checkbox" name="prices[]"
                                                                value="{{ $range }}"
                    ...
                    <nav class="custom-pagination">
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item {{ $products->onFirstPage() ? 'disabled' : '' }}">
                                <a class="page-link" href="{{ $products->appends($queryParams)->url(1) }}"
                                    tabindex="-1">
                            ...
                            <li class="page-item {{ $products->onFirstPage() ? 'disabled' : '' }}">
                                <a class="page-link"
                                    href="{{ $products->appends($queryParams)->previousPageUrl() ?? 'javascript:void(0)' }}">
                            ...
                            @for ($i = $start; $i <= $end; $i++)
                                <li class="page-item {{ $products->currentPage() == $i ? 'active' : '' }}">
                                    <a class="page-link"
                                        href="{{ $products->appends($queryParams)->url($i) }}">{{ $i }}</a>
                                </li>
                            @endfor
                            ...
                            <li
                                ...
                                <a class="page-link"
                                    href="{{ $products->appends($queryParams)->nextPageUrl() ?? 'javascript:void(0)' }}">
                            ...
                            <li
                                class="page-item {{ $products->currentPage() == $products->lastPage() ? 'disabled' : '' }}">
                                <a class="page-link"
                                    href="{{ $products->appends($queryParams)->url($products->lastPage()) }}">
