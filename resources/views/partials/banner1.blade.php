                ...
                <div class="banner-contain-3 hover-effect">
                    ...
                    <div class="banner-detail banner-details-dark text-white p-center-left w-50 position-relative mend-auto">
                        <div>
                            ...
                            <button class="btn theme-color bg-white btn-md fw-bold mt-sm-3 mt-1 mend-auto" onclick="location.href = '{{ url('shop-left-sidebar') }}';">
                                Comprar Ahora
                            </button>
                        </div>
                    </div>
                ...
                <div class="banner-contain-3 hover-effect">
                    ...
                    <div class="banner-detail text-dark p-center-left w-50 position-relative mend-auto">
                        <div>
                            ...
                            <button class="btn theme-bg-color text-white btn-md fw-bold mt-sm-3 mt-1 mend-auto" onclick="location.href = '{{ url('shop-left-sidebar') }}';">
                                Comprar Ahora
                            </button>
                        </div>
                    </div>
