                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="../assets/images/fruit/product/1.png" id="img-1"
                                                        data-zoom-image="../assets/images/fruit/product/1.png"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="../assets/images/fruit/product/2.png"
                                                        data-zoom-image="../assets/images/fruit/product/2.png"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="../assets/images/fruit/product/3.png"
                                                        data-zoom-image="../assets/images/fruit/product/3.png"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="../assets/images/fruit/product/4.png"
                                                        data-zoom-image="../assets/images/fruit/product/4.png"
                                                        class="
                                    ...
                                    <ul class="image select-package">
                                        <li class="form-check">
                                            ...
                                            <label class="form-check-label" for="small">
                                                <img src="../assets/images/fruit/product/5.png" alt="">
                                            </label>
                                        </li>
                                        <li class="form-check">
                                            ...
                                            <label class="form-check-label" for="medium">
                                                <img src="../assets/images/fruit/product/6.png" alt="">
                                            </label>
                                        </li>
                                    </ul>
                                </div>
