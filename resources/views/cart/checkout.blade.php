                                ...
                                <ul>
                                    <li>
                                        <div class="checkout-icon">
                                            <lord-icon target=".nav-item" src="../../ggihhudh.json" trigger="loop-on-hover"
                                                                    ...
                                                                    <ul class="delivery-address-detail">
                                                                        ...
                                                                        <li>
                                                                            <p class="text-content"><span
                                                                                    class="text-title">Ciudad:</span>
                                                                                {{ $address->city }}</p>
                                                                        </li>
                                                                        <li>
                                                                            <h6 class="text-content"><span
                                                                                    class="text-title">Estado:</span>
                                                                                {{ $address->state }}</h6>
                                                                        </li>
                                                                        <li>
                                                                            <h6 class="text-content"><span
                                                                                    class="text-title">Código Postal:</span>
                                                                                {{ $address->postal_code }}</h6>
                                                                        </li>
                                                                        <li>
                                                                            <h6 class="text-content"><span
                                                                                    class="text-title">País:</span>
                                                                                {{ $address->country }}</h6>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                    ...
                                    <li>
                                        <div class="checkout-icon">
                                            <lord-icon target=".nav-item" src="../../oaflahpk.json" trigger="loop-on-hover"
                                                colors="primary:#0baf9a" class="lord-icon">
                                            </lord-icon>
                                        </div>
                                        <div class="checkout-box">
                                            <div class="checkout-title">
                                                            ...
                                                            <div class="delivery-category">
                                                                <div class="shipment-detail">
                                                                    <div
                                                                        ...
                                                                        <label class="form-check-label" for="standard">Envio
                                                                            Normal</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <li>
                                        <div class="checkout-icon">
                                            <lord-icon target=".nav-item" src="../../qmcsqnle.json" trigger="loop-on-hover"
            ...
            <form action="{{ route('shipping.store') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn theme-bg-color text-white btn-md w-100 mt-4 fw-bold">Guardar
                            Dirección</button>
                    </div>
                </div>
            </form>
